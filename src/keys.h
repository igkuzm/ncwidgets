...
#define KEY_DELETE	'\177'	/* Delete key				*/
...
#ifdef __WIN32__
	#define MOUSE_LEFT_BUTTON  BUTTON1_PRESSED
	#define MOUSE_RIGHT_BUTTON BUTTON2_PRESSED
	#define MOUSE_SCROLL_DOWN  MOUSE_WHEEL_DOWN
	#define MOUSE_SCROLL_UP    MOUSE_WHEEL_UP
#elif defined __APPLE__
	#define nc_getmouse(event) getmouse(event)
	...
	#define MOUSE_SCROLL_DOWN  NCURSES_MOUSE_MASK(5, NCURSES_BUTTON_PRESSED)
	#define MOUSE_SCROLL_UP    NCURSES_MOUSE_MASK(4, NCURSES_BUTTON_PRESSED)
#endif
